                  ...
                  <div className="card-body p-0">
                    <ul className="nav-border nav nav-pills" role="tablist">
                      <li className="nav-item">
                        <a className="nav-link fw-semibold" data-bs-toggle="tab" href="#LogIn_Tab" role="tab">Log In</a>
                      </li>
                      <li className="nav-item">
                        <a className="nav-link active fw-semibold" data-bs-toggle="tab" href="#Register_Tab" role="tab">Register</a>
                      </li>
                    </ul>
                    {/* Tab panes */}
